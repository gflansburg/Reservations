<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCustomFieldDefinitionList.ascx.cs" Inherits="Gafware.Modules.Reservations.ViewCustomFieldDefinitionList" %>
                                ...
                                <columns>
                                    <asp:templatecolumn>
                                        <headerstyle cssclass="Gafware_Modules_Reservations_DataGrid_HeaderStyle_Button"
                                            width="52" />
                                        <itemstyle cssclass="Gafware_Modules_Reservations_DataGrid_ItemStyle_Button" width="52" />
                                        <itemtemplate>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="padding-left: 10px">
                                    <a class="Gafware_Modules_Reservations_CommandButton" href="<%=AddLinkButtonUrl%>"
                                        style="width: 175px">
