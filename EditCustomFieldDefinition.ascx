<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditCustomFieldDefinition.ascx.cs" Inherits="Gafware.Modules.Reservations.EditCustomFieldDefinition" %>
    ...
    <tr>
        <td width="100%" valign="top">
            <table width="100%" cellpadding="0" cellspacing="10" border="0" align="center" style="border: solid 1px #cccccc;">
                <tr>
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_SubHead" width="150" align="right">
                        ...
                        <asp:requiredfieldvalidator runat="server" controltovalidate="nameTextBox" enableclientscript="false"
                            display="Dynamic" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" forecolor="Red" />
                        <asp:customvalidator runat="server" controltovalidate="nameTextBox" enableclientscript="false"
                            display="Dynamic" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" forecolor="Red" onservervalidate="ValidateName" />
                    </td>
                    <td nowrap="nowrap" align="center" width="100%">
                        <table cellpadding="0" cellspacing="0" border="0" align="center" style="text-align: left"
                            width="100%">
                            <tr>
                                <td nowrap="nowrap" class="Gafware_Modules_Reservations_Normal" width="100%">
                                    <asp:textbox runat="server" id="nameTextBox" width="100%" cssclass="Gafware_Modules_Reservations_Input" />
                                </td>
                                <td nowrap="nowrap" class="Gafware_Modules_Reservations_Normal" style="padding-left: 5px">
                                    <asp:dropdownlist runat="server" id="typeDropDownList" width="200" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr runat="server" id="labelTableRow">
                    ...
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_Normal" width="100%">
                        <asp:textbox runat="server" id="labelTextBox" width="100%" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                <tr>
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_SubHead" width="150" align="right">
                ...
                <tr runat="server" id="titleTableRow">
                    ...
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_Normal" width="100%">
                        <asp:textbox runat="server" id="titleTextBox" width="100%" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                <tr runat="server" id="listItemsTableRow">
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_SubHead" width="150" align="right" valign="top" style="padding-top: 7px">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                            <tr>
                                <td style="margin-bottom: 0px">
                                    <table class="Gafware_Modules_Reservations_Normal Gafware_Modules_Reservations_DataGrid" cellspacing="0" cellpadding="2"
                                        style="width: 100%; border-collapse: collapse;" border="0">
                                        <tr>
                                            <td class="Gafware_Modules_Reservations_DataGrid_HeaderStyle_Button" style="width: 26px;">
                                                <asp:requiredfieldvalidator runat="server" controltovalidate="textTextBox" enableclientscript="false"
                                                    display="Dynamic" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" forecolor="Red" validationgroup="listItemValidationGroup" />
                                            </td>
                                            <td>
                                                <asp:textbox runat="server" id="textTextBox" validationgroup="listItemValidationGroup"
                                                    width="100%" cssclass="Gafware_Modules_Reservations_Input" />
                                            </td>
                                            <td>
                            ...
                            <tr>
                                <td style="margin-top: 0px">
                                    <asp:datagrid id="dataGrid" runat="server" datakeyfield="CustomFieldDefinitionListItemID"
                                        ...
                                        cssclass="Gafware_Modules_Reservations_Normal Gafware_Modules_Reservations_DataGrid" borderwidth="0">
                                        ...
                                        <columns>
                                            <asp:templatecolumn>
                                                <headerstyle cssclass="Gafware_Modules_Reservations_DataGrid_HeaderStyle_Button"
                                                    width="26" />
                                                <itemstyle cssclass="Gafware_Modules_Reservations_DataGrid_ItemStyle_Button" width="26" />
                                                <itemtemplate>
                                            ...
                                            <asp:templatecolumn>
                                                <headerstyle cssclass="Gafware_Modules_Reservations_DataGrid_HeaderStyle_Button"
                                                    width="52px" />
                                                <itemstyle cssclass="Gafware_Modules_Reservations_DataGrid_ItemStyle_RightButton"
                                                    width="52px" />
                                                <itemtemplate>
                ...
                <tr runat="server" id="numberOfRowsTableRow">
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_SubHead" width="150" align="right">
                        ...
                        <asp:requiredfieldvalidator runat="server" controltovalidate="numberOfRowsTextBox"
                            enableclientscript="false" display="Dynamic" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal"
                            forecolor="Red" />
                        <asp:rangevalidator runat="server" controltovalidate="numberOfRowsTextBox" enableclientscript="false"
                            display="Dynamic" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" forecolor="Red" minimumvalue="1"
                            maximumvalue="10" type="Integer" />
                    </td>
                    <td nowrap="nowrap" class="Gafware_Modules_Reservations_Normal" width="100%">
                        <asp:textbox runat="server" id="numberOfRowsTextBox" width="100%" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                ...
                <tr runat="server" id="createdByTableCell" visible="false">
                    <td nowrap="nowrap" align="center">
                        <asp:label id="createdByLabel" runat="server" cssclass="Gafware_Modules_Reservations_Normal" style="font-style: italic" />
                    </td>
                </tr>
                <tr runat="server" id="lastModifiedByTableCell" visible="false">
                    <td nowrap="nowrap" align="center">
                        <asp:label id="lastModifiedByLabel" runat="server" cssclass="Gafware_Modules_Reservations_Normal" style="font-style: italic" />
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td colspan="2" nowrap="nowrap" align="center" style="padding-bottom: 10px">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <a class="Gafware_Modules_Reservations_CommandButton" href="<%=ReturnUrl%>"
                            style="width: 80px">
                    ...
                    <td style="padding-left: 10px">
                        <asp:linkbutton runat="server" id="updateCommandButton" style="width: 125px" onclick="UpdateClicked"
                            cssclass="Gafware_Modules_Reservations_CommandButton" causesvalidation="true"><asp:image runat="server" imageurl="~/images/save.gif" width="16" height="16" resourcekey="updateCommandButton" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                    </td>
                </tr>
            </table>
        </td>
