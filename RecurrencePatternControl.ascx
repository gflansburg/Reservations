<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecurrencePatternControl.ascx.cs" Inherits="Gafware.Modules.Reservations.RecurrencePatternControl" %>
...
<table cellpadding="0" cellspacing="3" border="0">
        ...
        <td>
            <table cellpadding="0" cellspacing="3" border="0">
                <tr>
                    ...
                    <td>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceStartTimeHour"
                            style="text-align: center;" maxlength="2"  /><span class="Normal"> :
                        </span>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceStartTimeMinutes"
        ...
        <td>
            <table cellpadding="0" cellspacing="3" border="0">
                <tr>
                    ...
                    <td>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceEndTimeHour"
                            style="text-align: center;" maxlength="2" /><span class="Normal"> :
                        </span>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceEndTimeMinutes"
                            style="text-align: center;" maxlength="2" />
        ...
        <td>
            <table cellpadding="0" cellspacing="3" border="0">
                <tr>
                    ...
                    <td>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceDurationDays"
                            style="text-align: center;" maxlength="2" /><span class="Normal"> :
                        </span>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceDurationHours"
                            style="text-align: center;" maxlength="2" /><span class="Normal"> :
                        </span>
                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" width="35" id="recurrenceDurationMinutes"
                    ...
                    <td rowspan="4" style="padding-left: 10px; border-left: solid 1px #5c6f93" valign="top">
                        <asp:placeholder runat="server" id="dailyPatternPlaceHolder" visible="false">
                            <table cellpadding="0" cellspacing="0" border="0" width="400">
                                <tr>
                                    <td>
                                        <asp:radiobutton runat="server" id="dailyEveryDayRadioButton" groupname="dailyRatternRadioButtons" resourcekey="Every" cssclass="Normal" checked="true" />&nbsp;<asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="dailyEveryDayTextBox" text="1" width="30px" />&nbsp;<asp:label runat="server" cssclass="Normal" resourcekey="daysLabel" />
                        ...
                        <asp:placeholder runat="server" id="weeklyPatternPlaceHolder" visible="true">
                            <table cellpadding="0" cellspacing="0" border="0" width="400">
                                <tr>
                                    <td>
                                        <asp:label runat="server" resourcekey="Every" cssclass="Normal" />&nbsp; <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="weeklyEveryWeekTextBox" text="1" width="30px" />&nbsp;<asp:label runat="server" cssclass="Normal" resourcekey="weeksLabel" />
                        ...
                        <asp:placeholder runat="server" id="monthlyPatternPlaceHolder" visible="false">
                            <table cellpadding="0" cellspacing="0" border="0" width="400">
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <span class="Normal">
                                            <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="monthlyDayTextBox" text="1" width="30px" />&nbsp;<asp:label runat="server" resourcekey="ofEvery" />&nbsp;<asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="monthlyMonthTextBox" text="1" width="30px" />&nbsp;<asp:label runat="server" resourcekey="months" />
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 7px" nowrap="nowrap">
                                        <span class="Normal">
                                            <asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="monthlyDayPositionDropDownList" />&nbsp;<asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="monthlyDayTypeDropDownList" />&nbsp;<asp:label runat="server" resourcekey="ofEvery" />&nbsp;<asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="monthlyMonthTextBox2" text="1" width="30px" />&nbsp;<asp:label runat="server" resourcekey="months" />
                        ...
                        <asp:placeholder runat="server" id="yearlyPatternPlaceHolder" visible="false">
                            <table cellpadding="0" cellspacing="0" border="0" width="400">
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td>
                                                    <asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="yearlyMonthDropDownList" />
                                                </td>
                                                <td style="padding-left: 5px;">
                                                    <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="yearlyDayTextBox" text="1"
                                                        width="30px" />
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 7px;" nowrap="nowrap">
                                        <span class="Normal">
                                            <asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="yearlyDayPositionDropDownList" />
                                            &nbsp;<asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="yearlyDayTypeDropDownList" />
                                            &nbsp;of&nbsp;<asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="yearlyMonthDropDownList2" />
                                        </span>
                                    </td>
                                </tr>
                            </table>
                ...
                <tr>
                    ...
                    <td rowspan="3">
                        <table cellpadding="0" cellspacing="3" border="0">
                            <tr>
                                <td>
                                    <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="recurrenceStartDate" style="text-align: center" width="100" />
                    ...
                    <td rowspan="2">
                        <table cellpadding="0" cellspacing="3" border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" enabled="false" style="visibility:hidden;"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="Normal">
                                        <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="recurrenceEndAfterTextBox"
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td width="155">
                                                <asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="recurrenceEndDate" style="text-align: center" width="100" />
    ...
    <tr>
        <td colspan="2" align="center">
            <asp:linkbutton runat="server" cssclass="Gafware_Modules_Reservations_CommandButton"
