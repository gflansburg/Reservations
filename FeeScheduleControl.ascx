<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FeeScheduleControl.ascx.cs" Inherits="Gafware.Modules.Reservations.FeeScheduleControl" %>
                    ...
                    <td rowspan="4" style="padding-left:10px; border-left: solid 1px #5c6f93">
                            ...
                            <table cellpadding="0" cellspacing="3" border="0" width="300px">
                                <tr>
                                    ...
                                    <td valign="top" nowrap="nowrap">
                                        <asp:textbox runat="server" id="depositFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                            width="50" />&nbsp;
                                        ...
                                        <asp:rangevalidator runat="server" controltovalidate="depositFeeTextBox" resourcekey="starLabel"
                                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="false" display="Dynamic" minimumvalue="0"
                                            maximumvalue="65535" type="Currency" />
                                        <asp:requiredfieldvalidator runat="server" controltovalidate="depositFeeTextBox"
                                            resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="false" display="Dynamic" />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="250">
                                    ...
                                    <td valign="top" nowrap="nowrap">
                                        <asp:textbox runat="server" id="schedulingFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                            width="50" />&nbsp;
                                        <asp:label runat="server" resourcekey="schedulingFeeTypeLabel" cssclass="Gafware_Modules_Reservations_SubHead" />&nbsp;
                                        <asp:textbox runat="server" id="schedulingFeeIntervalTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                            width="50" />&nbsp;
                                        <asp:dropdownlist runat="server" id="schedulingFeeIntervalDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                        ...
                                        <asp:rangevalidator runat="server" controltovalidate="schedulingFeeIntervalTextBox" resourcekey="starLabel"
                                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="false" display="Dynamic" minimumvalue="1"
                                ...
                                <tr>
                                    ...
                                    <td valign="top" nowrap="nowrap">
                                        <asp:textbox runat="server" id="reschedulingFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                            width="50" />&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <asp:textbox runat="server" id="cancellationFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                            width="50" />&nbsp;
                                        ...
                                        <asp:customvalidator runat="server" controltovalidate="cancellationFeeTextBox" validateemptytext="true"
                                            ...
                                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="false" display="Dynamic" />
                                    </td>
                                </tr>
                            </table>
                        </asp:placeholder>
                        <asp:placeholder runat="server" id="seasonalSchedulePlaceHolder" visible="false">
                            <table cellpadding="0" cellspacing="0" border="0" width="300px">
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:datagrid runat="server" id="seasonalFeesDataGrid" showheader="False" showfooter="False"
                                            ...
                                            <itemstyle cssclass="Gafware_Modules_Reservations_Settings_DataGrid_ItemStyle2" />
                                            <columns>
                                                <asp:templatecolumn runat="server">
                                                    <itemtemplate>
                                                        <table width="100%" cellpadding="0" cellspacing="10" class="Gafware_Modules_Reservations_Settings_DataGrid_SeasonalFees">
                                                            <tr>
                                                                <td nowrap="nowrap">
                                        ...
                                        <asp:label runat="server" id="noSeasonalFeesLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                                    ...
                                    <td colspan="2" align="center">
                                        <table cellpadding="0" cellspacing="5" border="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="seasonalStartMonthDropDownList" />&nbsp;<asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="seasonalStartDayTextBox" text="1" width="30px" />
                                                ...
                                                <td>
                                                    <asp:dropdownlist cssclass="Gafware_Modules_Reservations_Input" runat="server" id="seasonalEndMonthDropDownList" />&nbsp;<asp:textbox cssclass="Gafware_Modules_Reservations_Input" runat="server" id="seasonalEndDayTextBox" text="1" width="30px" />
                                    ...
                                    <td colspan="2">
                                        <table cellpadding="0" cellspacing="3" border="0" width="300px">
                                            <tr>
                                                ...
                                                <td valign="top" nowrap="nowrap">
                                                    <asp:textbox runat="server" id="seasonalDepositFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                                        width="50" />&nbsp;
                                                    <asp:label runat="server" resourcekey="depositFeeTypeLabel"
                                                        cssclass="Gafware_Modules_Reservations_SubHead" />
                                                    ...
                                                    <asp:requiredfieldvalidator runat="server" controltovalidate="seasonalDepositFeeTextBox"
                                                        resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="false" display="Dynamic" validationgroup="seasonalValidationGroup" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td valign="top" nowrap="nowrap">
                                                    <asp:textbox runat="server" id="seasonalSchedulingFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                                        width="50" />&nbsp;
                                                    <asp:label runat="server" resourcekey="schedulingFeeTypeLabel" cssclass="Gafware_Modules_Reservations_SubHead" />&nbsp;
                                                    <asp:textbox runat="server" id="seasonalSchedulingFeeIntervalTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                                        width="50" />&nbsp;
                                                    <asp:dropdownlist runat="server" id="seasonalSchedulingFeeIntervalDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" nowrap="nowrap">
                                                    <asp:textbox runat="server" id="seasonalReschedulingFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                                        width="50" />&nbsp;
                                                    <asp:label runat="server" resourcekey="reschedulingFeeTypeLabel"
                                                        cssclass="Gafware_Modules_Reservations_SubHead" />
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top">
                                                    <asp:textbox runat="server" id="seasonalCancellationFeeTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                                        width="50" />&nbsp;
                                                    <asp:label runat="server" resourcekey="cancellationFeeTypeLabel"
                                                        cssclass="Gafware_Modules_Reservations_SubHead" />
                                                    ...
                                                    <asp:customvalidator runat="server" controltovalidate="seasonalCancellationFeeTextBox" validateemptytext="true"
                                                        ...
                                                        cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="false" display="Dynamic" validationgroup="seasonalValidationGroup" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:linkbutton runat="server" id="seasonalSaveCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton" validationgroup="seasonalValidationGroup" visible="false"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="Save" /></asp:linkbutton>
                                        <asp:linkbutton runat="server" id="seasonalCancelCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton" visible="false" causesvalidation="false" style="margin-left: 10px;"><asp:image runat="server" imageurl="~/images/delete.gif" /><asp:label runat="server" resourcekey="Cancel" /></asp:linkbutton>
                                        <asp:linkbutton runat="server" id="seasonalAddCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton" causesvalidation="false"><asp:image runat="server" imageurl="~/images/add.gif" /><asp:label runat="server" resourcekey="Add" /></asp:linkbutton>
                                    </td>
                                </tr>
                            </table>
                        </asp:placeholder>
