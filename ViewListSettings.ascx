<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewListSettings.ascx.cs" Inherits="Gafware.Modules.Reservations.ViewListSettings" %>
                    ...
                    <td>
                        <table runat="server" id="settingsTable" cellspacing="0" cellpadding="8" border="0"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:datagrid id="displayColumnDataGrid" runat="server" autogeneratecolumns="False"
                                        ...
                                        <headerstyle cssclass="Gafware_Modules_Reservations_SubHead" />
                                        <itemstyle cssclass="Gafware_Modules_Reservations_Normal" />
                                        <columns>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:dropdownlist id="sortColumnDropDownList" runat="server" cssclass="Gafware_Modules_Reservations_Input"
                                        width="100" style="vertical-align: middle" />
                                    &nbsp;<asp:dropdownlist id="sortOrderDirectionDropDownList" runat="server" cssclass="Gafware_Modules_Reservations_Input"
                                        width="100" style="vertical-align: middle" />
                                    &nbsp;
                                    ...
                                    <asp:datagrid id="sortColumnDataGrid" runat="server" gridlines="None" autogeneratecolumns="False"
                                        ...
                                        <columns>
                                            <asp:boundcolumn itemstyle-cssclass="Gafware_Modules_Reservations_Normal" datafield="LocalizedColumnName" />
                                            <asp:boundcolumn itemstyle-cssclass="Gafware_Modules_Reservations_Normal" datafield="LocalizedDirection" />
                                            <asp:templatecolumn>
                                                <itemtemplate>
                                                    <itemtemplate>
                                    ...
                                    <asp:label runat="server" id="noSortColumnsLabel" resourcekey="noSortColumnsLabel"
                                        cssclass="Gafware_Modules_Reservations_Normal" font-italic="true" visible="false" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 160px">
                            ...
                            <tr runat="server" id="pageSizeTableRow">
                                <td style="width: 160px">
                                    ...
                                    <asp:requiredfieldvalidator runat="server" controltovalidate="pageSizeTextBox" enableclientscript="true"
                                        display="Dynamic" cssclass="Gafware_Modules_Reservations_Normal" resourcekey="starLabel" />
                                    <asp:rangevalidator runat="server" controltovalidate="pageSizeTextBox" enableclientscript="true"
                                        display="Dynamic" cssclass="Gafware_Modules_Reservations_Normal" resourcekey="starLabel" minimumvalue="1"
                                        maximumvalue="1000" type="Integer" />
                                </td>
                                <td>
                                    <asp:textbox runat="server" id="pageSizeTextBox" cssclass="Gafware_Modules_Reservations_Input" width="178" />
                                </td>
                            </tr>
                            <tr runat="server" id="pagerModeTableRow">
                                ...
                                <td>
                                    <asp:dropdownlist runat="server" id="pagerModeDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                                        width="178" />
                                </td>
                            </tr>
                            <tr runat="server" id="pagerPositionTableRow">
                                ...
                                <td>
                                    <asp:dropdownlist runat="server" id="pagerPositionDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                                        width="178" />
                                </td>
                            </tr>
                                ...
                                <td colspan="2" align="center">
                                    <table cellpadding="0" cellspacing="5">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:linkbutton runat="server" id="updateCommandButton" style="width: 80px;" cssclass="Gafware_Modules_Reservations_CommandButton"
                                            ...
                                            <td runat="server" id="restoreDefaultTableCell">
                                                <asp:linkbutton onclientclick=<%#"return confirm('" + Localization.GetString( "RestoreDefaultConfirmation", LocalResourceFile ) + "');"%> runat="server" id="restoreDefaultCommandButton" style="width: 150px;" cssclass="Gafware_Modules_Reservations_CommandButton"
