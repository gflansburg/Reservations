<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewList.ascx.cs" Inherits="Gafware.Modules.Reservations.ViewList" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" runat="server" id="buttonsTable">
        <tr>
            ...
            <td align="right" style="padding-top: 10px">
                ...
                onclick="ExportCSVCommandButtonClicked" cssclass="Gafware_Modules_Reservations_CommandButton"
