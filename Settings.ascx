<%@ control language="C#" autoeventwireup="true" codebehind="Settings.ascx.cs" inherits="Gafware.Modules.Reservations.Settings" %>
    ...
    <tr runat="server" id="generalSettingsSectionTableRow">
        <td>
            ...
            <table runat="server" id="generalSettingsTable" cellspacing="0" cellpadding="5" border="0"
                width="500" align="center" class="Gafware_Modules_Reservations_SettingsTable">
                <tr>
                    <td width="250">
                        <dnn:label id="timeZoneLabel" runat="server" controlname="timeZoneDropDownList" />
                    </td>
                    <td valign="top">
                        <asp:dropdownlist width="100%" runat="server" id="timeZoneDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                <tr>
                    <td width="250">
                    ...
                    <td valign="top">
                        <asp:dropdownlist width="100%" runat="server" id="themeDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                <tr>
                    <td width="250">
                ...
                <tr runat="server" id="categorySelectionModeTableRow">
                    ...
                    <td valign="top" class="Gafware_Modules_Reservations_Normal">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="redirectUrlTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                    </td>
                </tr>
            </table>
            ...
            <table runat="server" id="categoriesTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr runat="server" id="categoryListTableRow">
                    ...
                    <td valign="top">
                        <asp:requiredfieldvalidator runat="server" controltovalidate="categoryNameTextBox"
                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Static" validationgroup="categoryNameValidationGroup" />
                        <asp:textbox runat="server" id="categoryNameTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                    </td>
                    <td width="16">
                ...
                <tr runat="server" id="categoryListTableRow2">
                    ...
                    <td valign="top">
                        <asp:datagrid runat="server" id="categoryListDataGrid" showheader="False" showfooter="False"
                            ...
                            <itemstyle cssclass="Gafware_Modules_Reservations_Settings_DataGrid_ItemStyle" />
                            <columns>
                                ...
                                <asp:templatecolumn runat="server">
                                    <itemtemplate>
                                        <asp:label runat="server" text='<%#DataBinder.Eval( Container.DataItem, "Name")%>'
                                            cssclass="Gafware_Modules_Reservations_Normal" />
                                    </itemtemplate>
                                </asp:templatecolumn>
                                <asp:templatecolumn runat="server">
                                    <itemtemplate>
                        ...
                        <asp:label runat="server" id="noCategoriesLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                ...
                <tr runat="server" id="categoryPermissionsTableRow">
                    ...
                    <td valign="top" style="padding-top: 8px;" colspan="2">
                        <table cellpadding="5" cellspacing="0" width="100%" class="Gafware_Modules_Reservations_SettingsTable">
                            <tr>
                                <td class="Gafware_Modules_Reservations_CategoryTableCell">
                                    <asp:dropdownlist runat="server" id="categoryPermissionsDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                            ...
                            <tr>
                                <td>
                                    <asp:checkboxlist runat="server" id="categoryPermissionsCheckboxList" cssclass="Gafware_Modules_Reservations_Normal" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:linkbutton runat="server" id="categoryPermissionsUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                            </td>
                                            <td style="padding-left: 5px">
                                                <asp:linkbutton runat="server" id="categoryPermissionsResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
    ...
    <tr runat="server" id="reservationSettingsSectionTableRow">
        <td>
            ...
            <table runat="server" id="reservationSettingsTable" cellpadding="5" cellspacing="0"
                border="0" width="500" align="center" class="Gafware_Modules_Reservations_SettingsTable">
                <tr runat="server" id="reservationSettingsCategoryTableRow" visible="false">
                    <td valign="top" colspan="2" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="reservationSettingsCategoryDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="minTimeAheadTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="minTimeAheadDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                        <asp:rangevalidator runat="server" controltovalidate="minTimeAheadTextBox" resourcekey="starLabel"
                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Dynamic" minimumvalue="-9999"
                            maximumvalue="9999" type="Integer" />
                        <asp:requiredfieldvalidator runat="server" controltovalidate="minTimeAheadTextBox"
                            resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Dynamic" />
                    </td>
                </tr>
                <tr>
                    <td width="250">
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="daysAheadTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:label runat="server" resourcekey="daysLabel" cssclass="Gafware_Modules_Reservations_SubHead" />
                        <asp:rangevalidator runat="server" controltovalidate="daysAheadTextBox" resourcekey="daysAheadTextBoxRangeValidator"
                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Dynamic" minimumvalue="0"
                        ...
                        <asp:requiredfieldvalidator runat="server" controltovalidate="daysAheadTextBox" resourcekey="starLabel"
                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Dynamic" />
                    </td>
                </tr>
                <tr>
                    <td width="250">
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="reservationIntervalTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="reservationIntervalDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="reservationDurationTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="reservationDurationDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="reservationDurationIntervalTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="reservationDurationIntervalDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="reservationDurationMaxTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="reservationDurationMaxDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="maxConflictingReservationsTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="maxReservationsPerUserTextBox" cssclass="Gafware_Modules_Reservations_Input" width="50" />
                        <asp:rangevalidator runat="server" controltovalidate="maxReservationsPerUserTextBox" resourcekey="starLabel"
                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Dynamic" minimumvalue="1"
                            maximumvalue="9999" type="Integer" />
                    </td>
                </tr>
                <tr runat="server" id="reservationSettingsUpdateResetTableRow">
                    <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="reservationSettingsUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="reservationSettingsResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr runat="server" id="feesSectionTableRow">
        <td>
            ...
            <table runat="server" id="feesTable" cellpadding="5" cellspacing="0" border="0" width="500"
                align="center" class="Gafware_Modules_Reservations_SettingsTable">
                <tr runat="server" id="reservationFeesCategoryTableRow" visible="false">
                    <td valign="top" colspan="2" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="reservationFeesCategoryDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr runat="server" id="paymentMethodTableRow">
                    ...
                    <td valign="top">
                        <asp:dropdownlist width="100%" runat="server" id="paymentMethodDropDownList" cssclass="Gafware_Modules_Reservations_Input" onselectedindexchanged="PaymentMethodChanged" autopostback="true" />
                    </td>
                </tr>
                <tr runat="server" id="payPalAccountTableRow">
                    <td width="250" class="Gafware_Modules_Reservations_PaymentMethodTableCell">
                        <dnn:label id="payPalAccountLabel" runat="server" controlname="payPalAccountTextBox" />
                    </td>
                    <td valign="top" class="Gafware_Modules_Reservations_PaymentMethodTableCell">
                        <asp:textbox runat="server" id="payPalAccountTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr runat="server" id="payPalUrlTableRow">
                    ...
                    <td valign="top" class="Gafware_Modules_Reservations_PaymentMethodTableCell">
                        <asp:textbox runat="server" id="payPalUrlTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr runat="server" id="authorizeNetApiLoginTableRow">
                    ...
                    <td valign="top" class="Gafware_Modules_Reservations_PaymentMethodTableCell">
                        <asp:textbox runat="server" id="authorizeNetApiLoginTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr runat="server" id="authorizeNetTransactionKeyTableRow">
                    ...
                    <td valign="top" class="Gafware_Modules_Reservations_PaymentMethodTableCell">
                        <asp:textbox runat="server" id="authorizeNetTransactionKeyTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr runat="server" id="authorizeNetMerchantHashTableRow">
                    ...
                    <td valign="top" class="Gafware_Modules_Reservations_PaymentMethodTableCell">
                        <asp:textbox runat="server" id="authorizeNetMerchantHashTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr runat="server" id="itemDescriptionTableRow">
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="payPalItemDescriptionTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr runat="server" id="pendingPaymentExpirationTableRow">
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="pendingPaymentExpirationTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:label runat="server" resourcekey="minutesLabel" cssclass="Gafware_Modules_Reservations_SubHead" />
                ...
                <tr runat="server" id="currencyTableRow">
                    ...
                    <td valign="top">
                        <asp:dropdownlist width="100%" runat="server" id="currencyDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                ...
                <tr runat="server" id="reservationFeesUpdateResetTableRow">
                    <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="reservationFeesUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="reservationFeesResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton" causesvalidation="false"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <td>
            ...
            <table runat="server" id="cashierListTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr runat="server" id="cashierListCategoryTableRow" visible="false">
                    <td valign="top" colspan="3" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="cashierListCategoryDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <asp:requiredfieldvalidator runat="server" id="cashierListUsernameRequiredFieldValidator"
                            controltovalidate="cashierListUsernameTextBox" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true"
                            display="Static" resourcekey="starLabel" validationgroup="cashierListUsernameValidationGroup"
                            visible="false" />
                    </td>
                    <td>
                        <asp:imagebutton runat="server" resourcekey="addCommandButton" imageurl="~/images/add.gif" ID="AddCashier"
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <columns>
                                <asp:templatecolumn runat="server" visible="false">
                                    <itemtemplate>
                                        ...
                                        <asp:label runat="server" id="email" visible="false" text='<%#( ( DotNetNuke.Entities.Users.UserInfo )Container.DataItem ).Email%>' />
                                    </itemtemplate>
                                </asp:templatecolumn>
                                <asp:templatecolumn runat="server">
                                    <itemtemplate>
                                        <asp:label runat="server" text='<%#( ( DotNetNuke.Entities.Users.UserInfo )Container.DataItem ).DisplayName%>' cssclass="Gafware_Modules_Reservations_Normal" />
                                    </itemtemplate>
                                </asp:templatecolumn>
                                <asp:templatecolumn runat="server">
                                    <itemtemplate>
                        ...
                        <asp:label runat="server" id="noCashiersLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                            resourcekey="noCashiersLabel" />
                    </td>
                </tr>
                <tr runat="server" id="cashierUpdateResetTableRow">
                    <td colspan="3" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="cashierListUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="cashierListResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <td>
            ...
            <table runat="server" id="workingHoursTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr runat="server" id="workingHoursCategoryTableRow" visible="false">
                    <td valign="top" colspan="2" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="workingHoursCategoryDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                        ...
                        <table cellpadding="10" cellspacing="0" border="0">
                            <%--<tr>
                                <td valign="top" nowrap="nowrap" rowspan="2">
                                    <asp:dropdownlist runat="server" id="weekDaysDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                </td>
                                <td valign="top" align="left" nowrap="nowrap">
                                    <asp:label runat="server" resourcekey="fromLabel" cssclass="Gafware_Modules_Reservations_SubHead" />
                                    <asp:dropdownlist runat="server" id="startHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="startMinuteDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="startAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:label runat="server" cssclass="Gafware_Modules_Reservations_SubHead" resourcekey="toLabel" />
                                    <asp:dropdownlist runat="server" id="endHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="endMinuteDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="endAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:customvalidator runat="server" validationgroup="workingHoursValidationGroup"
                                        controltovalidate="endHourDropDownList" cssclass="Gafware_Modules_Reservations_Normal" onservervalidate="ValidateWorkingHours" />
                                </td>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:datagrid runat="server" id="workingHoursDataGrid" showheader="False" showfooter="False"
                                        ...
                                        <itemstyle cssclass="Gafware_Modules_Reservations_Settings_DataGrid_ItemStyle" horizontalalign="Left" />
                                        <columns>
                                            <asp:templatecolumn runat="server">
                                                <itemtemplate>
                                                    <asp:imagebutton runat="server" imageurl="~/images/delete.gif" resourcekey="deleteCommandButton"
                                    ...
                                    <asp:label runat="server" id="noWorkingHoursLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                            ...
                            <tr>
                                <td align="center" style="padding: 20px; border-top: solid 1px #ccc">
                                    <asp:linkbutton runat="server" id="addWorkingHoursCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"
                ...
                <tr runat="server" id="workingHoursUpdateResetTableRow">
                    <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="workingHoursUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="workingHoursResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr runat="server" id="workingHoursExceptionsSectionTableRow">
        <td>
            ...
            <table runat="server" id="workingHoursExceptionsTable" cellpadding="5" cellspacing="0">
                <tr>
                    <td>
                        <asp:label runat="server" resourcekey="ExceptionsSettings.Help" cssclass="Gafware_Modules_Reservations_Normal" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <table cellpadding="5" cellspacing="0" border="0" width="500" align="center" class="Gafware_Modules_Reservations_SettingsTable"
                            ...
                            <tr runat="server" id="workingHoursExceptionsCategoryTableRow" visible="false">
                                <td valign="top" colspan="2" class="Gafware_Modules_Reservations_CategoryTableCell">
                                    <asp:dropdownlist runat="server" id="workingHoursExceptionsCategoryDropDownList"
                                        cssclass="Gafware_Modules_Reservations_Input" width="100%" onselectedindexchanged="WorkingHoursExceptionsCategoryDropDownListSelectedIndexChanged"
                                        autopostback="true" />
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tr>
                                            <td valign="middle" align="right" nowrap="nowrap">
                                                ...
                                                <asp:customvalidator runat="server" validateemptytext="true" validationgroup="workingHoursExceptionValidationGroup"
                                                    controltovalidate="workingHoursExceptionDateTextBox" cssclass="Gafware_Modules_Reservations_Normal" onservervalidate="ValidateWorkingHoursExceptionDate"
                                                    display="Dynamic" />
                                            </td>
                                            <td align="left" nowrap="nowrap">
                                                <asp:radiobutton runat="server" id="workingHoursExceptionFromRadioButton" groupname="workingHoursExceptionRadioButtonGroup"
                                                    resourcekey="fromLabel" cssclass="Gafware_Modules_Reservations_SubHead" checked="true" />
                                                ...
                                                <asp:dropdownlist runat="server" id="workingHoursExceptionStartAMPMDropDownList"
                                                    cssclass="Gafware_Modules_Reservations_Input" />
                                                <asp:label runat="server" cssclass="Gafware_Modules_Reservations_SubHead" resourcekey="toLabel" />
                                                <asp:dropdownlist runat="server" id="workingHoursExceptionEndHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                                <asp:dropdownlist runat="server" id="workingHoursExceptionEndMinuteDropDownList"
                                                    cssclass="Gafware_Modules_Reservations_Input" />
                                                <asp:dropdownlist runat="server" id="workingHoursExceptionEndAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                                <asp:customvalidator runat="server" validationgroup="workingHoursExceptionValidationGroup"
                                                    controltovalidate="workingHoursExceptionEndHourDropDownList" cssclass="Gafware_Modules_Reservations_Normal"
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" align="left">
                                                <asp:radiobutton runat="server" id="workingHoursExceptionNoWorkingHoursRadioButton"
                                                    ...
                                                    cssclass="Gafware_Modules_Reservations_SubHead" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" align="center" style="padding-top: 10px">
                                                <asp:datagrid runat="server" id="workingHoursExceptionsWorkingHoursDataGrid" showheader="False"
                                                    ...
                                                    <columns>
                                                        <asp:templatecolumn runat="server" visible="false">
                                                            <itemtemplate>
                                                                <asp:label runat="server" id="dateLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursExceptionInfo )Container.DataItem ).Date.ToString( )%>' />
                                                                <asp:label runat="server" id="startTimeLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursExceptionInfo )Container.DataItem ).StartTime.ToString( )%>' />
                                                                <asp:label runat="server" id="endTimeLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursExceptionInfo )Container.DataItem ).EndTime.ToString( )%>' />
                                                                <asp:label runat="server" id="allDayLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursExceptionInfo )Container.DataItem ).AllDay.ToString( )%>' />
                                                            </itemtemplate>
                                                        </asp:templatecolumn>
                                                        <asp:templatecolumn runat="server">
                                                            <itemtemplate>
                                                                <asp:label runat="server" text='<%#GetWorkingHoursException( ( Gafware.Modules.Reservations.WorkingHoursExceptionInfo )Container.DataItem )%>'
                                                                    cssclass="Gafware_Modules_Reservations_Normal" />
                                                            </itemtemplate>
                                                        </asp:templatecolumn>
                                                        <asp:templatecolumn runat="server">
                                                ...
                                                <asp:label runat="server" id="workingHoursExceptionsNoWorkingHoursLabel" cssclass="Gafware_Modules_Reservations_Normal"
                            ...
                            <tr runat="server" id="workingHoursExceptionsUpdateResetTableRow">
                                <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:linkbutton runat="server" id="workingHoursExceptionsUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                            </td>
                                            <td style="padding-left: 5px">
                                                <asp:linkbutton runat="server" id="workingHoursExceptionsResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table cellpadding="5" cellspacing="0">
                            <tr>
                                <td valign="top" nowrap="nowrap" align="right">
                                    <asp:textbox runat="server" id="timeOfDayNameTextBox" cssclass="Gafware_Modules_Reservations_Input"
                                        width="100" />
                                </td>
                                <td valign="top" nowrap="nowrap">
                                    <asp:dropdownlist runat="server" id="timeOfDayStartHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="timeOfDayStartMinuteDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="timeOfDayStartAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:label runat="server" cssclass="Gafware_Modules_Reservations_SubHead" resourcekey="toLabel" />
                                    <asp:dropdownlist runat="server" id="timeOfDayEndHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="timeOfDayEndMinuteDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="timeOfDayEndAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:requiredfieldvalidator runat="server" validationgroup="timeOfDayValidationGroup"
                                        controltovalidate="timeOfDayNameTextBox" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal"
                                        display="Dynamic" />
                                    <asp:customvalidator runat="server" validationgroup="timeOfDayValidationGroup" controltovalidate="timeOfDayEndHourDropDownList"
                                        resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal" onservervalidate="ValidateTimeOfDay"
                                        display="Dynamic" />
                                </td>
                                <td valign="middle" nowrap="nowrap">
                                    <asp:imagebutton runat="server" resourcekey="addCommandButton" imageurl="~/images/add.gif"
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                    <asp:customvalidator runat="server" controltovalidate="timeOfDayEndHourDropDownList"
                                        resourcekey="TimeOfDayListError" cssclass="Gafware_Modules_Reservations_Normal" onservervalidate="ValidateTimeOfDayList"
                                        display="Dynamic" />
                                    <asp:datagrid runat="server" id="timeOfDayDataGrid" showheader="False" showfooter="False"
                                        ...
                                        <columns>
                                            ...
                                            <asp:templatecolumn runat="server">
                                                <itemtemplate>
                                                    <asp:label runat="server" text='<%#GetTimeOfDay( ( Gafware.Modules.Reservations.TimeOfDayInfo )Container.DataItem )%>'
                                                        cssclass="Gafware_Modules_Reservations_Normal" />
                                                </itemtemplate>
                                            </asp:templatecolumn>
                                            <asp:templatecolumn runat="server">
                                                <itemtemplate>
                                                    <asp:imagebutton cssclass="CommandButton Gafware_Modules_Reservations_LinkCommandButton"
                                                        runat="server" imageurl="~/images/delete.gif" resourcekey="deleteCommandButton"
                                                        commandname="Delete" causesvalidation="false" />
                                                </itemtemplate>
                                            </asp:templatecolumn>
                                    ...
                                    <asp:label runat="server" id="noTimeOfDayLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
        ...
        <td>
            ...
            <table runat="server" id="notificationsTable" cellpadding="5" cellspacing="0" width="500"
                ...
                <tr runat="server" id="bccListCategoryTableRow" visible="false">
                    <td valign="top" colspan="3" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="bccListCategoryDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <asp:requiredfieldvalidator runat="server" id="usernameRequiredFieldValidator" controltovalidate="usernameTextBox"
                            cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true" display="Static" resourcekey="starLabel"
                            validationgroup="usernameValidationGroup" visible="false" />
                    </td>
                    <td valign="mibble">
                        <asp:imagebutton runat="server" resourcekey="addCommandButton" imageurl="~/images/add.gif" ID="addUser"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:label runat="server" id="noUsersLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                ...
                <tr runat="server" id="bccListUpdateResetTableRow">
                    <td colspan="3" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="bccListUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="bccListResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <td>
            ...
            <table runat="server" id="moderationTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr runat="server" id="moderationCategoryTableRow" visible="false">
                    <td valign="top" colspan="3" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="moderationCategoryDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr runat="server" id="globalModeratorsDropDownListTableRow">
                    ...
                    <td>
                        ...
                        <asp:requiredfieldvalidator runat="server" id="moderatorUsernameRequiredFieldValidator"
                            controltovalidate="moderatorUsernameTextBox" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true"
                            display="Static" resourcekey="starLabel" validationgroup="moderatorUsernameValidationGroup"
                            visible="false" />
                    </td>
                    <td width="16">
                        <asp:imagebutton runat="server" resourcekey="addCommandButton" imageurl="~/images/add.gif" ID="AddGlobalModerator"
                ...
                <tr runat="server" id="globalModeratorsDataGridTableRow">
                    ...
                    <td>
                        ...
                        <asp:label runat="server" id="noGlobalModeratorsLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                ...
                <tr runat="server" id="moderationHoursTableRow">
                    <td colspan="3" style="padding: 0px">
                        <table cellpadding="5" cellspacing="0" border="0">
                            ...
                            <tr>
                                <td valign="top" nowrap="nowrap" rowspan="2">
                                    <asp:dropdownlist runat="server" id="moderationWeekDaysDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                </td>
                                <td valign="top" align="left" nowrap="nowrap">
                                    <asp:label runat="server" resourcekey="fromLabel" cssclass="Gafware_Modules_Reservations_SubHead" />
                                    <asp:dropdownlist runat="server" id="moderationStartHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="moderationStartMinuteDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="moderationStartAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:label runat="server" cssclass="Gafware_Modules_Reservations_SubHead" resourcekey="toLabel" />
                                    <asp:dropdownlist runat="server" id="moderationEndHourDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="moderationEndMinuteDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:dropdownlist runat="server" id="moderationEndAMPMDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                                    <asp:customvalidator runat="server" validationgroup="moderationHoursValidationGroup"
                                        controltovalidate="moderationEndHourDropDownList" resourcekey="starLabel" cssclass="Gafware_Modules_Reservations_Normal"
                                ...
                                <td colspan="3" align="center" style="padding-top: 10px">
                                    <asp:datagrid runat="server" id="moderationHoursDataGrid" showheader="False" showfooter="False"
                                        ...
                                        <columns>
                                            <asp:templatecolumn runat="server" visible="false">
                                                <itemtemplate>
                                                    <asp:label runat="server" id="dayOfWeekLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursInfo )Container.DataItem ).DayOfWeek.ToString( )%>' />
                                                    <asp:label runat="server" id="startTimeLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursInfo )Container.DataItem ).StartTime.ToString( )%>' />
                                                    <asp:label runat="server" id="endTimeLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursInfo )Container.DataItem ).EndTime.ToString( )%>' />
                                                    <asp:label runat="server" id="allDayLabel" visible="false" text='<%#( ( Gafware.Modules.Reservations.WorkingHoursInfo )Container.DataItem ).AllDay.ToString( )%>' />
                                                </itemtemplate>
                                            </asp:templatecolumn>
                                            <asp:templatecolumn runat="server">
                                                <itemtemplate>
                                                    <asp:label runat="server" text='<%#GetWorkingHours( ( Gafware.Modules.Reservations.WorkingHoursInfo )Container.DataItem )%>'
                                                        cssclass="Gafware_Modules_Reservations_Normal" />
                                                </itemtemplate>
                                            </asp:templatecolumn>
                                            <asp:templatecolumn runat="server">
                                    ...
                                    <asp:label runat="server" id="noModerationHoursLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                ...
                <tr runat="server" id="moderationUpdateResetTableRow">
                    <td colspan="3" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="moderationUpdateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="moderationResetCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table runat="server" id="reportsTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <asp:requiredfieldvalidator runat="server" id="duplicateReservationsUsernameRequiredFieldValidator"
                            controltovalidate="duplicateReservationsUsernameTextBox" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true"
                            display="Static" resourcekey="starLabel" validationgroup="duplicateReservationsUsernameValidationGroup"
                            visible="false" />
                    </td>
                    <td valign="middle">
                        <asp:imagebutton runat="server" resourcekey="addCommandButton" imageurl="~/images/add.gif" ID="AddDuplicateReservations"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:label runat="server" id="noDuplicateReservationsLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <asp:requiredfieldvalidator runat="server" id="viewReservationsUsernameRequiredFieldValidator"
                            controltovalidate="viewReservationsUsernameTextBox" cssclass="Gafware_Modules_Reservations_Normal" enableclientscript="true"
                            display="Static" resourcekey="starLabel" validationgroup="viewReservationsUsernameValidationGroup"
                            visible="false" />
                    </td>
                    <td valign="middle">
                        <asp:imagebutton runat="server" resourcekey="addCommandButton" imageurl="~/images/add.gif" ID="AddViewReservations"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:label runat="server" id="noViewReservationsLabel" cssclass="Gafware_Modules_Reservations_Normal" font-italic="true"
        ...
        <td>
            ...
            <table runat="server" id="remindersTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr runat="server" id="sendRemindersViaTableRow" visible="false">
                    ...
                    <td valign="top">
                        <asp:dropdownlist width="100%" runat="server" id="sendRemindersViaDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                    </td>
                </tr>
                <tr runat="server" id="sendRemindersWhenTableRow" visible="false">
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="sendRemindersWhenTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="sendRemindersWhenDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                ...
                <tr runat="server" id="requireConfirmationWhenTableRow" visible="false">
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="requireConfirmationWhenTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="50" />
                        <asp:dropdownlist runat="server" id="requireConfirmationWhenDropDownList" cssclass="Gafware_Modules_Reservations_Input" />
                ...
                <tr runat="server" id="requireConfirmationTableRow2" visible="false">
                    <td class="Gafware_Modules_Reservations_Normal" colspan="2">
    ...
    <tr runat="server" id="mailTemplatesSectionTableRow">
        <td>
            ...
            <table runat="server" id="mailTemplatesTable" cellpadding="5" cellspacing="0" border="0"
                width="600" align="center" class="Gafware_Modules_Reservations_SettingsTable">
                <tr>
                    <td width="100">
                        <dnn:label id="mailFromLabel" runat="server" controlname="mailFromTextBox" />
                    </td>
                    <td valign="top">
                        <asp:textbox runat="server" id="mailFromTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="iCalendarAttachmentFileNameTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                ...
                <tr>
                    ...
                    <td class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="mailTemplateDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="mailTemplateSubjectTextBox" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="mailTemplateBodyTextBox" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td>
                        <asp:radiobutton runat="server" id="mailTemplateBodyTypeHtmlRadioButton" groupname="mailTemplateBodyTypeRadioButtonGroup"
                            cssclass="Gafware_Modules_Reservations_Normal" resourcekey="mailTemplateBodyTypeHtmlRadioButton" />
                        <asp:radiobutton runat="server" id="mailTemplateBodyTypeTextRadioButton" groupname="mailTemplateBodyTypeRadioButtonGroup"
                            cssclass="Gafware_Modules_Reservations_Normal" resourcekey="mailTemplateBodyTypeTextRadioButton" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="updateMailTemplateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="resetMailTemplateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <td>
            ...
            <table runat="server" id="smsTemplatesTable" cellpadding="5" cellspacing="0" border="0"
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="twilioAccountSIDTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="twilioAuthTokenTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="twilioFromTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            width="100%" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="Gafware_Modules_Reservations_CategoryTableCell">
                        <asp:dropdownlist runat="server" id="smsTemplateDropDownList" cssclass="Gafware_Modules_Reservations_Input"
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:textbox runat="server" id="smsTemplateBodyTextBox" cssclass="Gafware_Modules_Reservations_Input"
                            textmode="MultiLine" rows="20" width="100%" maxlength="2000" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center" class="Gafware_Modules_Reservations_CategoryTableCell">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:linkbutton runat="server" id="updateSMSTemplateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton" causesvalidation="false"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                                </td>
                                <td style="padding-left: 5px">
                                    <asp:linkbutton runat="server" id="resetSMSTemplateCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton" causesvalidation="false"><asp:image runat="server" imageurl="~/images/reset.gif" /><asp:label runat="server" resourcekey="resetCommandButton" /></asp:linkbutton>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr runat="server" id="updateCancelTableRow" visible="false">
        <td align="center">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:linkbutton runat="server" id="updateSettingsCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/save.gif" /><asp:label runat="server" resourcekey="updateCommandButton" /></asp:linkbutton>
                    </td>
                    <td style="padding-left: 5px">
                        <asp:linkbutton runat="server" id="cancelSettingsCommandButton" cssclass="Gafware_Modules_Reservations_CommandButton"><asp:image runat="server" imageurl="~/images/delete.gif" /><asp:label runat="server" resourcekey="cancelCommandButton" /></asp:linkbutton>
                    </td>
                </tr>
            </table>
        </td>
